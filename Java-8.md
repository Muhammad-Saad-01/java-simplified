...
exampleMethod("from concrete class");
...
accept("consumed value");

// Real-world example
List<String> names = Arrays.asList("Ahmed", "Mohamed", "Sara");
names.

forEach(consumer); // Prints each name
```
